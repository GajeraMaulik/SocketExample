...
import com.example.socketexample.Service.MyBeaconWorker
...
/*
      ...
      if (mLocationDialog == null){
        ...
        if (!userPermission!!.checkAccessCoarseLocationPermission()) {
            ...
            if (!SocketBackgroundService.isServiceRunning(this, SocketBackgroundService::class.java)) {
...
/*    fun sendMessage() {
   ...
   // Internet On/Off
   private fun showNetworkMessage(isConnected: Boolean): Boolean {
        if (!isConnected) {
          ...
          //  userPermission!!.requestOverlayPermission()
           ...
           if (!locationManager.isLocationEnabled) {
               if (mLocationDialog != null && !mLocationDialog!!.isShowing) {
                       Utility.locationDialog(this@MainActivity)
